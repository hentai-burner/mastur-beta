...
####    QUICKSETUP.PS1
##    Redo of Setup.ps1, probably updated after setup, sets up automatically with as few prompts as possible.
##    Needs to:
...
$kinkOn = @($true,   $true,     $false,  $false,$true,  $false,$false, $true,   $true,     $true)
